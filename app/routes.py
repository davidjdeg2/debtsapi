...
@api_bp.route('/debt/<int:id>', methods=['GET'])
def get_debt(id):
...
@api_bp.route('/debts/<int:debt_id>/add', methods=['PUT'])
...
@api_bp.route('/debts/<int:debt_id>/subtract', methods=['PUT'])
...
@api_bp.route('/debts/<int:debt_id>/interest', methods=['GET'])
